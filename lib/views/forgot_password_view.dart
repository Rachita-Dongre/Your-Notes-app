...
import 'package:yournotes/utilities/dialogs/error_dialog.dart';
import 'package:yournotes/utilities/dialogs/password_reset_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  'If you forgot your password, simply enter your email and we will send you a password reset link through email.'),
              TextField(
